...
The goal of this project is to automate the testing of the API Test Server, focusing on REST API testing. 
...
### ⤵️️ Clone the Repository

To get started, clone the project repository using Git:

```bash
git clone gh repo clone Vitaly-Miller/autotests-api-httpx
