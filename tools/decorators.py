...
#---------------------------------------------------- API Report -------------------------------------------------------
# ⚠️РАБОТАЕТ ТОЛЬКО С ФИКСТУРНЫМИ Response.
# Не видит локальную переменную response. Тогда нужно добавлять return response в конце теста
# Принято решение не использовать этот декоратор, а использовать Tool.api_report(response) в конце теста.
