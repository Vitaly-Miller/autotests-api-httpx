...
# Exercises Client
@pytest.fixture
def exercises_client(create_user_pydantic: CreateUserSchema) -> ExercisesClient:
    """
...
# Pydantic-model (full)
@pytest.fixture
def create_exercise_pydantic(exercises_client: ExercisesClient, create_course_pydantic: CreateCourseSchema) -> CreateExerciseSchema:
    """
...
# API
@pytest.fixture
def get_exercise_api(exercises_client: ExercisesClient, create_exercise_pydantic: CreateExerciseSchema) -> httpx.Response:
    """
    API-фикстура получения задания по Exercise ID

    :param exercises_client: Вложенная Pydantic-фикстура получения экземпляра ExercisesClient() (с Авторизацией)
    :param create_exercise_pydantic: Вложенная Pydantic-фикстура создания задания (для с Exercise ID)
    :return: httpx.Response
    """
...
# Pydantic-model
@pytest.fixture
def get_exercise_pydantic(exercises_client: ExercisesClient, create_exercise_pydantic: CreateExerciseSchema) -> GetExerciseResponseSchema:
    """
    Pydantic-фикстура получения задания по Exercise ID

    :param exercises_client: Вложенная Pydantic-фикстура получения экземпляра ExercisesClient() (с Авторизацией)
    :param create_exercise_pydantic: Вложенная Pydantic-фикстура создания задания (для получения Exercise-ID)
...
# API
@pytest.fixture
def get_exercises_api(exercises_client: ExercisesClient, create_course_pydantic: CreateCourseSchema) -> httpx.Response:
    """
    ...
    :return: httpx.Response
    """
    course_id_qwery_model = GetExercisesQwerySchema(courseId=create_course_pydantic.course_id) # Pydantic-model
...
# API
@pytest.fixture
def update_exercise_api(exercises_client: ExercisesClient, create_exercise_pydantic: CreateExerciseSchema) -> httpx.Response:
    """
...
# Pydantic-model
@pytest.fixture
def update_exercise_pydantic(exercises_client: ExercisesClient, create_exercise_pydantic: CreateExerciseSchema) -> UpdateExerciseResponseSchema:
    """
...
# API
@pytest.fixture
def delete_exercise_api(exercises_client: ExercisesClient, create_exercise_pydantic: CreateExerciseSchema) -> httpx.Response:
    """
