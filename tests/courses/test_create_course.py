...
from tools.assertions.courses_assert import assert_create_course_response_equal
...
class TestCreateCourse:
    def test_create_course(
        ...
        assert_create_course_response_equal(response)                           # Request Data = Response Data
