...
from tools.assertions.exercises_assert import (
    assert_create_exercise_response_data,
...
class TestCreateExercise:
    def test_create_exercise(
            ...
            create_user: CreateUserSchema,                            # Фикстура создания пользователя
            create_course: CreateCourseSchema                         # Фикстура создания курса
            ):
        create_exercise_data = CreateExerciseRequestSchema(           # Инициализация Pydantic-model c fake-data
        ...
        assert_create_exercise_response_data(response)                        # Response data = Request data
