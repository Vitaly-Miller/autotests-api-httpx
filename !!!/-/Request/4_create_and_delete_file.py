...
#--------------------------------------------------- 4. Create File ----------------------------------------------------
# 3. Относительный путь к файлу -> .parents[1] - на 3 уровня вверх относительно текущего файла с запросом
file_path = Path(__file__).parents[3]/'testdata'/'my_files'/'my_image.png'
